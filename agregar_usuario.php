        ...
        <form class="" id="frmAgregar" enctype="multipart/form-data">
            <div class="md:order-1">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="mb-6">
                        <label for="contrasena" class="block mb-2 text-sm font-medium text-xl">Contraseña: <span style="color: red">*</span></label>
                        <input style="font-size: 20px" type="password" id="contrasena" name="contrasena" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="mb-6 ">
                        <label for="rol" class="block mb-2 text-sm font-medium text-xl">Correo: <span style="color: red">*</span></label>
