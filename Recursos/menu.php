    ...
    <div>
        ...
        <div id="dropdownAvatar" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
            <div class="px-4 py-3 text-md text-gray-900 ">
                <div>Yahir Sibrian</div>
                <div class="font-medium truncate">yahirstewart@gmail.com</div>
            </div>
        ...
        <div> <a href="dashboard.php" class="nav_logo"> <img src="Media/logo_white.png" style="height: 15px" /> <span class="nav_logo-name">DIVER </span> </a>
            <div class="nav_list">
                ...
                ?>
                    ...
                    <a href="#" class="nav_link"> <i class="bx bxs-collection"></i><span class="nav_name">Creditos Fiscal</span> </a>
