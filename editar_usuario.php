        ...
        <form class="" id="frmEditar" enctype="multipart/form-data">
            <div class="md:order-1">
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="mb-6">
                        <div class="relative">
                            ...
                            <div data-popover id="popover-click" role="tooltip" class="absolute z-20 invisible inline-block w-full text-sm text-green-500 transition-opacity duration-300 bg-green-200 border border-green-400 rounded-lg shadow-sm opacity-0 ">
                                <div class="px-3 py-2">
                                    <p id="paramNombre1"> <i class='bx bx-check h-full'></i> Nombre minimo de 3 letras.</p>
                                </div>
                    ...
                    <div class="mb-6">
                        <div class="relative">
                            ...
                            <div data-popover id="popover-apellido" role="tooltip" class="absolute z-20 invisible inline-block w-full text-sm text-green-500 transition-opacity duration-300 bg-green-200 border border-green-400 rounded-lg shadow-sm opacity-0 ">
                                <div class="px-3 py-2">
                                    <p id="paramApellido1"> <i class='bx bx-check h-full'></i> Apellido minimo de 3 letras.</p>
                                </div>
                                <div data-popper-arrow></div>
                            </div>
                        </div>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="mb-6">
                        <div class="relative">
                            ...
                            <div data-popover id="popover-username" role="tooltip" class="absolute z-20 invisible inline-block w-full text-sm text-green-500 transition-opacity duration-300 bg-green-200 border border-green-400 rounded-lg shadow-sm opacity-0 ">
                                <div class="px-3 py-2">
                                    <p id="paramUsername1"> <i class='bx bx-check h-full'></i> Cumple el formato "texto.texto" .</p>
                                </div>
                                <div data-popper-arrow></div>
                            </div>
                        </div>
                    ...
                    <div class="mb-6">
                        <div class="relative">
                            ...
                            <div data-popover id="popover-correo" role="tooltip" class="absolute z-20 invisible inline-block w-full text-sm text-green-500 transition-opacity duration-300 bg-green-200 border border-green-400 rounded-lg shadow-sm opacity-0 ">
                                <div class="px-3 py-2">
                                    <p id="paramCorreo1"> <i class='bx bx-check h-full'></i> Cumple el formato "ejemplo@ejemplo.ejem".</p>
                                </div>
                                <div data-popper-arrow></div>
                            </div>
                        </div>
                ...
                <div class="w-full flex justify-between items-center">
                    ...
                    <button type="submit" class="focus:outline-none text-xl text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg px-5 py-2.5 mr-2 "><i class='bx bxs-edit' ></i></button>
                </div>
            </div>
        </form>
    </div>
