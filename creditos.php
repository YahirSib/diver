...
<body id="body-pd">
    ...
    <div class="flex w-full flex-col mt-8 ">
        <div class="flex items-center justify-between mb-5">
            <h1 class="text-5xl font-extrabold text-[#101954] ">Creditos fiscales de <?php echo $array[date('n') - 1];?></h1>
        </div>
    ...
    <script src="Controlador/scripts/Creditos/ver_creditos.js"></script>
</body>
